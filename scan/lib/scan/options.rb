    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :fail_build,
                                    ...
                                    type: Boolean,
                                    default_value: true),
        FastlaneCore::ConfigItem.new(key: :postprocess_retry,
                                    env_name: 'SCAN_POSTPROCESS_RETRY',
                                    description: "When enabled, lets Fastlane use the legacy post-test-run retry strategy instead of default xcodebuild -retry-tests-on-failure",
                                    type: Boolean,
                                    default_value: false)
